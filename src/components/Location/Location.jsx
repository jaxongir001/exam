...
function Location() {
  return (
    <div style={{display:'flex', justifyContent:'center', alignItems:'center', width:'1400px',height:'600px',background:'#fff',marginBottom:'20px', marginTop:'40px'}}>
        ...
        <div className="right" style={{width:'49%', height:'96%', border:'2px solid #E5E2EE', marginLeft:'15px',background:'white',borderRadius:'20px'}}>
            ...
            <div style={{display:'inline-block', width:'90%', height:'330px', marginLeft:'30px'}} className="input">
                <div style={{display:'flex', alignItems:'center',marginTop:'5px',  border:'1px solid #7A7687', borderLeft:'none',borderRight:'none',borderTop:'none', width:'90%', height:'50px'}} className="input1"><input style={{width:'99%',height:'40px', border:'none', background:'white',}} type="text" placeholder='Ваше имя'/></div>
                <div style={{display:'flex', alignItems:'center',marginTop:'5px', border:'1px solid #7A7687', borderLeft:'none',borderRight:'none',borderTop:'none', width:'90%', height:'50px'}} className="input1"><input style={{width:'99%',height:'40px', border:'none',background:'white'}} type="text" placeholder='Ваш телефон'/></div>
                <div style={{display:'flex', alignItems:'center',marginTop:'5px', border:'1px solid #7A7687', borderLeft:'none',borderRight:'none',borderTop:'none', width:'90%', height:'50px'}} className="input1"><input style={{width:'99%',height:'40px', border:'none',background:'white'}} type="text" placeholder='Ваш email'/></div>
                <div style={{display:'flex', alignItems:'start',marginTop:'5px', border:'1px solid #7A7687', borderLeft:'none',borderRight:'none',borderTop:'none', width:'90%', height:'100px'}} className="input1"><input style={{width:'99%',height:'40px', border:'none',background:'white'}} type="text" placeholder='Ваш email'/></div>
            </div>
